...
class PhotosGridAdapter constructor(
        private var photosList: List<BookImagesData>) : RecyclerView.Adapter<PhotosGridAdapter.CustomViewHolder>() {
    ...
    fun setList(photosList: List<BookImagesData>) {
        this.photosList = photosList
        notifyDataSetChanged()
    }

    override fun onBindViewHolder(holder: CustomViewHolder, position: Int) {
        holder.bind(photoUri = photosList[position].imgPath)
    }
