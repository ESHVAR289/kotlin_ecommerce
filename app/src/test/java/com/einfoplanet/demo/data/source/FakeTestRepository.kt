...
class FakeTestRepository : CartListRepository {
    ...
    override fun removeFromCart(cartProduct: CartProduct) {
        _allCartProductsData.value = _allCartProductsData.value!!.minus(cartProduct)
    }

    override fun addProductToCart(cartProduct: CartProduct) {
        _allCartProductsData.value = _allCartProductsData.value!!.plus(cartProduct)
    }
